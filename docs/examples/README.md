...
* **Key Concepts**: Single front-door intake, hierarchical delegation (`Chief → Personal`), Slack and Terminal interfaces, scoped memory, and step-by-step instructions for extending the workforce.
* **Roadmap & Gaps**: See [TODO.md](headquarters/TODO.md).
...
3. **Interface & Host Wiring**: Learn how to attach external transports (like Slack Socket Mode or Terminal) to an always-running Host daemon.
