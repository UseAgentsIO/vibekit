...
4. If working in another repository, use an installed `vibekit` binary or `npx --yes @useagentsio/cli@0.1.1`. Never install or invoke the unrelated unscoped npm package named `vibekit`.
